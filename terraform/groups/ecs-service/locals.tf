...
locals {
  ...
  lb_listener_paths          = ["/gov-uk-notify-integration/letter", "/gov-uk-notify-integration/email", "/gov-uk-notify-integration/healthcheck", "/gov-uk-notify-integration/api-key-mappings*"]
